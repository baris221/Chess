...
def GetValideHand(game,piece):
    ...
    if(piece[0]==1):
        if(piece[3]<7):           
           if(game[0][piece[2]][piece[3]+1]==0):
              ValideHand.append([piece[2],piece[3]+1])
              
        if(piece[3]==1 and game[0][piece[2]][piece[3]+2]==0 and game[0][piece[2]][piece[3]+1]==0):
              ValideHand.append([piece[2],piece[3]+2])
    ...
    if(piece[0]==2):
        if(piece[3]>0):
            ...
            if(piece[3]==6 and game[0][piece[2]][piece[3]-2]==0 and game[0][piece[2]][piece[3]-1]==0):
                ValideHand.append([piece[2],piece[3]-2])
